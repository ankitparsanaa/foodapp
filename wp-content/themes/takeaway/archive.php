          ...
          <h1 class="archive-title">
              ...
              <?php
                if ( is_day() ) {
                  ...
                  printf( __( 'Daily Archives: %s', 'takeaway' ), '<span>' . get_the_date() . '</span>' );
                }

                  else if ( is_month() ) {

                          printf( __( 'Monthly Archives: %s', 'takeaway' ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', 'takeaway' ) ) . '</span>' );
                        }

                        else if ( is_year() ) {

                                printf( __( 'Yearly Archives: %s', 'takeaway' ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', 'takeaway' ) ) . '</span>' );
                             }

                             else {

                                    _e( 'Archives For : '.  ucwords(get_the_author( ))  .' ', 'takeaway' );
                            }
              ?>
