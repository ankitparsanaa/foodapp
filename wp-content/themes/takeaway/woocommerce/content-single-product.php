                      ...
                      <div class="visible-option">
                        <div class="details">
                            ...
                            <ul class="share-this list-inline text-right">
                                ...
                                <li>
                                <a href="http://www.facebook.com/sharer.php?u=<?php the_permalink();?> "><i class="fa fa-facebook-square"></i>
                                </a>
                                </li>
                                ...
                                <li><a href="https://plus.google.com/share?url=<?php the_permalink();?>"><i class="fa fa-google-plus-square"></i></a>
                                </li>
                                <li><a href="https://pinterest.com/pin/create/button/?url=<?php the_permalink();?>&amp;media=<?php echo urlencode(get_the_title()); ?>"><i class="fa fa-pinterest-square"></i></a>
                                </li>
                                </ul>
                                </li>
                            </ul>
                            ...
                            <?php $takeaway_main_price = get_post_meta($post->ID , '_price_for_grouped_product_grp_product_price', true); ?>
                              <h4><?php if($product->product_type == 'food')  {
