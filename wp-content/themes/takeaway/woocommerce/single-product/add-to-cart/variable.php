                            ...
                            if ( is_array( $options ) ) {
                                ...
                                if ( taxonomy_exists( sanitize_title( $name ) ) ) {
                                    ...
                                    foreach ( $terms as $term ) {
                                        ...
                                        echo '<input type="radio" value="' . strtolower($term->slug) . '" ' . 
                                    ...
                                    checked( sanitize_title( $selected_value ), sanitize_title( $option ), false ) .
                                     ' id="'. esc_attr( sanitize_title($name) ) .
                                     '" name="attribute_'. sanitize_title($name).'">' . 
                                     apply_filters( 'woocommerce_variation_option_name', $option ) . '<br />';
                                }
                            }
                        ?>
                    </fieldset> <?php
